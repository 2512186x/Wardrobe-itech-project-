...
class PageForm(forms.ModelForm):
    ...
    #img = forms.ImageField(help_text="Please upload the picture of the clothes.")
...
class ArticleForm(forms.ModelForm):
    ...
    #uploader = forms.ModelChoiceField(queryset=User.get_username,required=True, empty_label=None,help_text="Please select the uploader.")
